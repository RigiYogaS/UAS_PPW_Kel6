...
<head>
    <title>Morev</title>
    <link rel="stylesheet" href="<?= base_url('/cssDashboard/news.css'); ?>">
        ...
        <div class="gabungan">
            <div class="news">
                ...
                <div class="news-item">
                    ...
                    <div>
                        <h3>
                            <a
                                href="https://www.hollywoodreporter.com/movies/movie-news/francis-ford-coppola-comforts-todd-phillips-joker-folie-a-deux-flails-1236025277/">Francis
                                Ford Coppola Praises Todd Phillips as ‘Joker: Folie à
                ...
                <div class="news-item">
                    ...
                    <div>
                        <h3>
                            <a
                                href="https://www.hollywoodreporter.com/movies/movie-news/michel-blanc-dead-french-actor-les-bronzes-monsieur-hire-1236025296/">Michel
                                Blanc, French Actor in ‘Les Bronzés’ and ‘Monsieur
                                Hire,’ Dies at 72</a>
                        </h3>
                        <br /><br />
                ...
                <div class="news-item">
                    ...
                    <div>
                        <h3>
                            <a
                                href="https://www.hollywoodreporter.com/movies/movie-news/the-burbs-director-joe-dante-keke-palmer-remake-1236023731/">‘The
                                Burbs’ Director Reacts to Movie’s Keke Palmer-Led Series
                ...
                <div class="news-item">
                    ...
                    <div>
                        <h3>
                            <a
                                href="https://www.hollywoodreporter.com/movies/movie-news/pedro-almodovar-chaplin-award-2025-film-at-lincoln-center-1236024887/">Pedro
                                Almodóvar to Receive Film at Lincoln Center’s 2025
                                Chaplin Award</a>
                        </h3>
                        <br /><br />
            ...
            <div class="upcoming-films">
                ...
                <div class="film-item">
                    ...
                    <div>
                        <h3>
                            <a href="https://www.youtube.com/watch?v=__2bjWbetsA">Venom: The Last Dance</a>
                        </h3>
                        <p class="p">
                ...
                <div class="film-item">
                    ...
                    <div>
                        <h3>
                            <a href="https://www.youtube.com/watch?v=hDZ7y8RP5HE">Moana 2</a>
                        </h3>
                        <p class="p">
                ...
                <div class="film-item">
                    ><img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkbh7aQXD4y8HoajnrE1O2XYZk3ybxTqk61UDg1_AMtQzNUEb7"
                        alt="Mufasa Poster" />
                    <div>
                        <h3>
                            <a href="https://www.youtube.com/watch?v=MjQG-a7d41Q">Mufasa: The Lion King</a>
                        </h3>
                        <p class="p">
                ...
                <div class="film-item">
                    ...
                    <div>
                        <h3>
                            <a href="https://www.youtube.com/watch?v=qSu6i2iFMO0">Sonic 3</a>
                        </h3>
                        <p class="p">
